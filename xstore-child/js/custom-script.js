...
jQuery(document).ready(function($){
    ...
    main_global = {
        ...
        checkAddressStates: function(states, selectedStates){
            ...
            switch( states ){
                ...
                case 'VIC':
                    $('#place_order').addClass('disabled');
                    $('#place_order').attr('disabled', true);
                    main_global.statesErrorMessage(selectedStates, 'vic.empassion.com.au');
        ...
        redirectStateMap: function(state_id, redirect){
            ...
            switch(state_id){
                ...
                case 'nt':
                    ...
                    break;
                case 'nsw':
                    state_link = 'https://woocommerce-138437-778829.cloudwaysapps.com';
                    break;
                case 'sa':
                    state_link = 'https://empassion.com.au/home';
                    break;
        ...
        selectState: function(){
            ...
            $('.select-state').find('button img').attr('src', '/wp-content/uploads/2018/08/nsw.png');
            $('.select-state').find('button .sel-desc').text('NSW');
            $('.select-state').find('button').attr('title', 'NSW');
